...
%   1. down-sampling to 500Hz
%   2. re-referenced using CAR
%   3. 4-butter-worth to 7 kind of bands
%   4. rectified 
%   5. 4Hz low pass filter
%   6. z-score normalization
%   7. data - min(data)

function [preFilt,BFIL] = test_FiltECoG_absGaus(Data,Hz,ResampleRate)
%%%%%%%%%%%%%%%%
filter.N = 2;
filter.Wn = [10 240];
filter.freq = 1375;
